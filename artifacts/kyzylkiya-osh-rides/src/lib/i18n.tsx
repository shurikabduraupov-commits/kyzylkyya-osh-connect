...
const translations: Record<Language, Dict> = {
  kg: {
    ...
    "auth.telegram.lead":
      "Кызматты колдонуу үчүн Telegram аккаунтыңыз менен бир жолу кириңиз (катталуу). Бул жерде телефонду жазуу керек эмес — сиздин Telegram ID жана ат сакталат. Телефон номери кийин гана керек: жүргүнчү заявка жөнөткөндө же айдоочу профилин толтурганда.",
    ...
    "tabs.lock.driver-disabled":
      "Сизде активдүү жүргүнчү заявкасы бар. Айдоочу бөлүмүнө өтүү үчүн аны аяктаңыз же жокко чыгарыңыз.",
    "tabs.lock.passenger-disabled":
      "Сизде активдүү айдоочу жарыясы/сапары бар. Жүргүнчү бөлүмүнө өтүү үчүн аны аяктаңыз же токтотуңуз.",
    "role-lock.passenger-active":
      "Адегенде жүргүнчү заявкаңызды аяктаңыз же жокко чыгарыңыз, анан айдоочу режимине өтө аласыз.",
    "role-lock.driver-active":
      "Адегенде айдоочу жарыяңызды/сапарыңызды аяктаңыз же токтотуңуз, анан жүргүнчү режимине өтө аласыз.",
    ...
    "driver.pickup-map.title": "Жүргүнчүнү алууга чейинки жол",
    "driver.pickup-map.subtitle":
      "Картада сиз (көк) жана чогултуу жери (жашыл). Толук маршрут үчүн геолокацияны күйгүзүңүз.",
    "driver.pickup-map.loading-address": "Дарек изделүүдө…",
    "driver.pickup-map.geocode-error": "Даректи картага байланыштыруу мүмкүн болгон жок.",
    "driver.pickup-map.route-fallback": "Толук маршрут алынган жок — түз сызык көрсөтүлүүдө.",
    "driver.pickup-map.waiting-gps": "Сиздин жайгашууңуз изделүүдө…",
    "driver.pickup-map.need-location": "Сизден жүргүнчүгө чейинки жол үчүн жайгашуу керек.",
    "driver.pickup-map.enable-location": "Жайгашууну күйгүзүү",
    "driver.pickup-map.marker-you": "Сиз",
    "driver.pickup-map.marker-passenger": "Чогултуу",
    "driver.pickup-map.disclaimer":
      "Карталар — OpenStreetMap. Маршрут OSRM демо-сервери аркылуу; тактыгы кепилденбейт.",
    ...
    "driver.progress.enroute": "Жүргүнчүгө жөнөдү",
    "driver.progress.arrived": "Жүргүнчүгө келди",
    "driver.progress.assigned": "Заявканы кабыл алды",
    ...
    "driver.progress.intrip": "Баштапкы пункттан чыкты",
    "driver.progress.completed": "Акыркы пунктка жетти",
  ...
  ru: {
    ...
    "auth.telegram.lead":
      "Чтобы пользоваться сервисом, один раз войдите через Telegram — это и есть регистрация: мы сохраняем только ваш Telegram ID и имя из профиля. Номер телефона на этом шаге вводить не нужно; он понадобится позже — когда вы отправите заявку как пассажир или заполните профиль водителя.",
    ...
    "tabs.lock.driver-disabled":
      "У вас есть активная заявка пассажира. Чтобы перейти в режим водителя, завершите или отмените её.",
    "tabs.lock.passenger-disabled":
      "У вас есть активное объявление/поездка водителя. Чтобы перейти в режим пассажира, завершите или остановите её.",
    "role-lock.passenger-active":
      "Сначала завершите или отмените вашу заявку пассажира, потом сможете перейти в режим водителя.",
    "role-lock.driver-active":
      "Сначала завершите или остановите вашу активность водителя, потом сможете перейти в режим пассажира.",
    ...
    "driver.pickup-map.title": "Маршрут к пассажиру (подбор)",
    "driver.pickup-map.subtitle":
      "На карте вы (синий) и точка посадки (зелёный). Для полного маршрута включите геолокацию.",
    "driver.pickup-map.loading-address": "Ищем адрес…",
    "driver.pickup-map.geocode-error": "Не удалось привязать адрес к карте.",
    "driver.pickup-map.route-fallback": "Полный маршрут недоступен — показана прямая линия.",
    "driver.pickup-map.waiting-gps": "Определяем ваше местоположение…",
    "driver.pickup-map.need-location": "Нужна геолокация, чтобы построить путь к пассажиру.",
    "driver.pickup-map.enable-location": "Включить геолокацию",
    "driver.pickup-map.marker-you": "Вы",
    "driver.pickup-map.marker-passenger": "Посадка",
    "driver.pickup-map.disclaimer":
      "Карта © OpenStreetMap. Маршрут через демо-сервер OSRM; точность не гарантируется.",
