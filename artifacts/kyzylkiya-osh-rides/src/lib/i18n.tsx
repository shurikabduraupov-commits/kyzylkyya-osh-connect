...
const translations: Record<Language, Dict> = {
  kg: {
    ...
    "passenger.released.toast.title": "Айдоочу баш тартты",
    "passenger.released.toast.desc": "Жаңы айдоочу издөөдө",
    ...
    "driver.offers.cancelled.desc": "Жүргүнчүлөр сизди мындан ары көрбөйт",
    ...
    "passenger.drivers.subtitle": "Акыркы убакта жүргүнчү алгандар",
  ...
  ru: {
    ...
    "passenger.released.toast.title": "Водитель отказался",
    "passenger.released.toast.desc": "Ищем нового водителя",
    ...
    "driver.offers.cancelled.desc": "Пассажиры больше не увидят его",
    ...
    "passenger.drivers.subtitle": "Кто недавно брал пассажиров",
