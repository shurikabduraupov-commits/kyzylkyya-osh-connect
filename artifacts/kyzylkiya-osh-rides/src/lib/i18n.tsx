...
const translations: Record<Language, Dict> = {
  kg: {
    ...
    "passenger.address.hint": "Тандаган шаар боюнча көчө же объектти сунуштардан тандаңыз",
  ...
  ru: {
    ...
    "passenger.address.hint": "Выберите улицу или объект из подсказок для выбранного города",
