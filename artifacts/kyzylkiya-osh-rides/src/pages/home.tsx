        ...
        <div className="max-w-md mx-auto relative z-10">
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-2">
              ...
              <h1 className="font-display text-2xl font-bold tracking-tight">Jol<span className="opacity-80">Tap</span></h1>
            </div>
            
            {stats && (
              <div className="text-right text-sm">
                <p className="font-medium text-white/90">Today</p>
                <p className="opacity-80">{stats.acceptedRequests} trips • {stats.totalSeats} seats</p>
              </div>
            )}
          </div>

          <div className="flex items-center gap-3 text-white/90 font-medium text-lg">
            <span>Kyzyl-Kiya</span>
